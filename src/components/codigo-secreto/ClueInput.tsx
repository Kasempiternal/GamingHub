    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      <div className="text-center mb-2">
        <h3 className="text-white font-bold text-base sm:text-lg flex items-center justify-center gap-2">
          ...
          Da tu pista, Jefe de Espias
        </h3>
        <p className="text-slate-400 text-xs sm:text-sm">Una palabra + numero de cartas relacionadas</p>
      </div>
      ...
      <div className="flex gap-2">
        <input
          ...
          className={`
            flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg bg-slate-700/50 border-2 ${borderColor}
            text-white text-center text-base sm:text-xl font-bold uppercase tracking-wider
        ...
        <select
          ...
          disabled={disabled || loading}
          className={`
            w-16 sm:w-20 px-1 sm:px-2 py-2 sm:py-3 rounded-lg bg-slate-700/50 border-2 ${borderColor}
            text-white text-center text-base sm:text-xl font-bold
      ...
      <button
        ...
        className={`
          w-full py-2 sm:py-3 px-4 sm:px-6 rounded-lg font-bold text-white text-sm sm:text-base
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <span className="truncate">Dar Pista: {word || '___'} {number}</span>
          </>
        )}
      </button>

      <div className="text-[10px] sm:text-xs text-slate-500 text-center space-y-0.5">
        <p>El numero indica cuantas palabras estan relacionadas</p>

            ...
            <div className="space-y-4">
              <div className="bg-slate-900/50 rounded-xl p-4">
                ...
                <p className="text-slate-300 text-sm leading-relaxed">
                  Codigo Secreto es un juego de palabras por equipos. Tu equipo debe encontrar todas sus cartas secretas antes que el equipo rival usando pistas de una sola palabra.
                </p>
              </div>
              ...
              <div className="bg-slate-900/50 rounded-xl p-4">
                ...
                <div className="mt-3 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-slate-300 text-sm">Asesino (1 carta - perder instantaneo!)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-purple-900/50 to-purple-800/30 rounded-xl p-4 border border-purple-700/50">
                ...
                <ul className="text-slate-300 text-sm space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400">-</span>
                    <span>Da pistas de UNA palabra + un numero</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400">-</span>
                    <span>El numero indica cuantas cartas relaciona</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400">-</span>
              ...
              <div className="bg-gradient-to-br from-emerald-900/50 to-emerald-800/30 rounded-xl p-4 border border-emerald-700/50">
                ...
                <ul className="text-slate-300 text-sm space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400">-</span>
                    <span>Puede hacer hasta [numero + 1] intentos</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400">-</span>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-xs">Hablan entre ellos sobre que cartas elegir</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4">
                ...
                <ul className="text-slate-300 text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Como Jefe: busca conexiones entre multiples palabras</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">-</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">-</span>
                    <span>Si no estas seguro, pasa el turno</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">-</span>

...
import { useCodigoSecreto } from '@/hooks/useCodigoSecreto';
import {
  GameBoard,
  TeamPanel,
  ClueInput,
...
export default function CodigoSecretoRoom() {
  ...
  const {
    ...
    respondToProposal,
    cancelProposal,
  } = useCodigoSecreto({ roomCode, playerId, pollInterval: 1500 });
  ...
  const getShareUrl = () => {
    if (typeof window !== 'undefined') {
      return `${window.location.origin}/codigo-secreto/unirse/${roomCode}`;
    }
    return '';
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <svg className="w-12 h-12 text-white animate-spin mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <main className={`min-h-screen p-2 sm:p-4 no-bounce safe-area-top safe-area-bottom ${game.phase === 'playing' && player?.team ? 'pt-16' : ''}`}>
      ...
      <header className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-white">Codigo Secreto</h1>
            ...
            {player?.isHost && (
              <div className="text-center">
                ...
                <p className="text-slate-500 text-sm mt-2">
                  Cada equipo necesita al menos 2 jugadores y un Jefe de Espias
                </p>
              </div>
            )}
        ...
        {game.phase === 'playing' && (
          <div className="space-y-4">
            ...
            {game.currentClue && (
              ...
              `}>
                <div className="text-slate-400 text-sm mb-1">Pista del Jefe de Espias</div>
      ...
      <ConfirmationDialog
        ...
        message="Estas seguro de que quieres seleccionar esta carta?"

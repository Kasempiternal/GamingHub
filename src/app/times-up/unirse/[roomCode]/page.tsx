      ...
      <main className="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        >
          <div className="w-20 h-20 bg-amber-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-4xl" role="img" aria-label="timer">&#x23F1;</span>
          </div>
          <h1 className="text-2xl font-bold text-white mb-2">Partida en curso</h1>
          <p className="text-slate-400 mb-6">
            La partida con codigo <span className="font-mono text-white">{roomCode}</span> ya ha comenzado y no acepta nuevos jugadores.
          </p>
          <Link
            href="/times-up"
            className="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors"
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 safe-area-top safe-area-bottom">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-orange-500 to-yellow-500 rounded-2xl mb-4 shadow-xl">
            <motion.span
              className="text-3xl"
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Unirse a Tiempo!</h1>
        ...
        >
          <div className="space-y-4">
            ...
            <button
              onClick={handleJoin}
              disabled={loading}
              className="w-full py-3 px-6 bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
